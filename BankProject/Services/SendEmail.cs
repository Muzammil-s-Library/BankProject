...
namespace BankProject.Services
{
    public class SendEmail : IEmailSender
    {
        ...
        private const string TemplateId = "d-bd8ba901ee814471aa436118490b5345"; // Replace with your Template ID
        private const string FromEmail = "muzammiltanoli817@gmail.com"; // Use the verified sender email

        public static async Task<bool> SendTemplateEmail(string recipientEmail, string recipientName, string otpCode)
        {
            try
            {
                ...
                var dynamicTemplateData = new Dictionary<string, string>
                {
                    ...
                    { "otp_code", otpCode }      // Pass the OTP code
                };
